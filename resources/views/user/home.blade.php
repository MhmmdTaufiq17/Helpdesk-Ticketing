...
<style>
    ...
    .page-sidebar .info-card:nth-child(1) { animation: fadeSlideUp .45s .1s ease both; }
    .page-sidebar .info-card:nth-child(2) { animation: fadeSlideUp .45s .18s ease both; }
    .page-sidebar .info-card:nth-child(3) { animation: fadeSlideUp .45s .26s ease both; }
</style>
            ...
            <form action="{{ route('user.tickets.store') }}" method="POST" enctype="multipart/form-data" id="ticketForm">
                ...
                <div class="field">
                    ...
                    <textarea name="description"
                              ...
                              placeholder="Jelaskan masalah secara detail — termasuk langkah yang sudah dicoba, pesan error, dll."
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form?.addEventListener('submit', function (e) {
        ...
        if (submitBtn) {
            ...
            submitBtn.innerHTML = '<svg fill="none" stroke="currentColor" viewBox="0 0 24 24" style="animation: spin 1s linear infinite;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15"/></svg> Mengirim...';
        }
    });
    ...
    function showNotif(type, title, sub) {
        ...
        notif.innerHTML = `${icon}<div class="fn-body"><strong>${title}</strong><span>${sub}</span></div>`;
