...
<body class="text-slate-900 m-0 min-h-screen antialiased overflow-x-hidden">
    ...
    <div class="hidden fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-[190] transition-opacity" id="sidebarOverlay">
    </div>
    ...
    <aside
            ...
            <div>
                ...
                <div class="mt-4 space-y-1">
                    ...
                    <a href="{{ route('admin.settings.index') }}"
                        class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ request()->routeIs('admin.settings.*') ? 'bg-[#5b5ef4] text-white shadow-lg' : 'text-slate-400 hover:bg-white/5 hover:text-slate-200' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="p-4 mt-auto">
            <div class="bg-white/5 rounded-2xl p-4 border border-white/5">
                <div class="flex items-center gap-3">
                    <div
                        class="w-10 h-10 bg-[#5b5ef4] rounded-xl flex items-center justify-center font-bold text-white shadow-inner">
