    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .nav-search-form {
            ...
            transition: border-color .2s, box-shadow .2s; gap: 4px;
        }
        ...
        .nav-search-input {
            ...
            padding: 9px 6px; outline: none; min-width: 0;
        }
        ...
        .nav-search-error {
            ...
            z-index: 200; align-items: center; gap: 8px;
        }
        ...
        .nav-mobile-btn {
            ...
            padding: 8px; border-radius: 8px; color: var(--ink-2); margin-left: auto;
        }
        ...
        .nav-mobile-menu {
            ...
            padding: 12px 20px 20px; z-index: 99; box-shadow: var(--shadow-lg);
        }
        ...
        .nav-mobile-search {
            display: flex; align-items: center;
            background: var(--surface-2); border: 1.5px solid var(--surface-3);
            border-radius: 10px; padding: 0 4px 0 12px; gap: 6px;
        ...
        .nav-mobile-error {
            ...
            font-size: 12.5px; color: var(--red); align-items: center; gap: 8px;
        }
        ...
        .nav-mobile-link.active { background: var(--accent-soft); color: var(--accent); }
        ...
        .footer {
            ...
            padding: 40px 24px; margin-top: 80px; font-size: 13px;
        }
        .footer-inner {
        ...
        .footer-brand {
            ...
            color: rgba(255,255,255,.8); font-weight: 600; font-size: 14px; text-decoration: none;
        }
...
<div class="nav-mobile-menu" id="mobileMenu">
    <div class="nav-mobile-search-wrap">
        <div class="nav-mobile-search">
            <svg width="15" height="15" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                 style="color:var(--ink-3);flex-shrink:0">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/>
            </svg>
    ...
    <div class="nav-mobile-links">
        <a href="{{ route('user.home') }}"
           class="nav-mobile-link {{ request()->routeIs('user.home') ? 'active' : '' }}">
...
<script>
    ...
    function setLoading(btn, loading) {
        ...
        btn.innerHTML = loading ? '<span class="btn-spinner"></span>Mencari…' : 'Cari';
    }
