...
<body
        ...
        <div class="relative mb-6">
            <div
                ...
                <button type="button" id="mobileSearchBtn"
                    class="bg-[#5b5ef4] text-white rounded-lg px-5 py-2 text-sm font-bold">Lacak</button>
            </div>
    ...
    <script>
        ...
        // ── KUNCI PERBAIKAN: Global Click & Submit Loader ──
        document.addEventListener('click', (e) => {
            const link = e.target.closest('a');
            if (link && link.href && !link.target && !link.href.includes('#') && !link.href.startsWith('mailto') &&
